...
class Display:
    ...
    def draw_environment(self, environment, player, non_player_characters):
        ...
        for npc in non_player_characters:
            npc_screen_x = npc.x - player.x + SCREEN_WIDTH // 2 - npc.sprite_width // 2
            npc_screen_y = npc.y - player.y + SCREEN_HEIGHT // 2 - npc.sprite_height // 2
            self.screen.blit(npc.get_current_sprite(), (npc_screen_x, npc_screen_y))
